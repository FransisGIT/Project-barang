...
<body>
    <div class="wrapper">
                                    ...
                                    <li>
                                        ...
                                        <form id="form" action="{{ route('logout') }}" method="post">
                                            ...
                                            <a href="javascript:void(0)"
                                                onclick="document.getElementById('form').submit()" class="dropdown-item"
                                                href="#">Logout</a>
                                        </form>
                                    </li>
                                </div>
        ...
        <div class="main-panel">
            <div class="content">
                <div class="panel-header bg-gradient" style="background-color: #220555">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Dashboard</h2>
                                <h5 class="text-white op-7 mb-2">KELOMPOK 2</h5>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="copyright ml-auto">
                        2018, made with <i class="fa fa-heart heart text-danger"></i> by <a
                            href="https://www.themekita.com">KELOMPOK 2</a>
                    </div>
                </div>
            </footer>
        </div>
